...
export const villas: VillaDetail[] = [
  {
    ...
    rates: [
      ...
      { label: 'Capacity', amount: 'Up to 20 Guests', description: 'Up to 60 for parties' },
    ],
    policies: [
      ...
      { icon: 'people', label: 'Party Capacity', value: 'Up to 60 guests (+₱200/person above 20)' },
      { icon: 'smoke_free', label: 'Smoking', value: 'Outdoor areas only' },
      { icon: 'camera', label: 'CCTV', value: 'Active in common areas' },
      { icon: 'party', label: 'Party Policy', value: '₱5,000 party fee · Max 60 guests' },
