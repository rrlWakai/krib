...
export const villas: VillaDetail[] = [
  {
    ...
    image: images.krib1,
    images: [images.krib1, images.krib1Bedroom, images.krib1Pool, images.galleryBathroom, images.krib1],
    ...
    price: '₱25,000 / 22-hour stay',
    priceDetails: {
      perNight: '₱25,000',
      rateType: '22-hour stay',
    },
    ...
    rates: [
      { label: '22-Hour Stay', amount: '₱20,000', description: 'Complete stay experience' },
  ...
  },
  {
    ...
    image: images.krib2,
    images: [images.k2, images.kk2, images.krib2Pool, images.galleryBreakfast,],
    capacity: 'Perfect for 14–16 guests',
    bedrooms: 4,
    bathrooms: 3,
    maxGuests: 30,
    highlights: [
    ...
    rates: [
      { label: '22-Hour Stay', amount: '₱25,000', description: 'Complete stay experience' },
...
export const galleryImages: GalleryImage[] = [
  {
    id: 'pool-aerial',
    src: images.morningCoffee,
    alt: 'Aerial view of private pool surrounded by lush greenery at KRiB Beverly Place',
  ...
  },
  {
    id: 'breakfast',
    src: images.krib1,
    alt: 'Outdoor breakfast setup at KRiB family villa',
  ...
  {
    id: 'bedroom',
    src: images.krib1Bedroom,
    alt: 'Cozy bedroom interior at KRiB Beverly Place',
    colSpan: 'col-span-12 md:col-span-4',
    rowSpan: 'row-span-1',
    delay: 400,
  },
  {
    id: 'garden',
    src: images.krib2,
    alt: 'Evening garden view at KRiB Signature Villa',
    colSpan: 'col-span-12 md:col-span-5',
    rowSpan: 'row-span-1',
    delay: 500,
  },
    ...
    items: [
      {
        ...
        answer:
          'Each reservation is a 22-hour stay, giving you a full day to enjoy the villa from check-in at 2:00 PM until check-out at 12:00 PM the following day. Extended stays can be arranged upon request.',
      },
      {
        id: 'check-in-out',
        question: 'What are the check-in and check-out times?',
        answer:
          'Check-in is at 2:00 PM and check-out is at 12:00 PM. Early check-in and late check-out may be arranged in advance, subject to availability on your booking date.',
      },
      {
        id: 'guest-capacity',
        question: 'How many guests can each villa accommodate?',
        answer:
          'KRiB 1 comfortably accommodates up to 20 guests with 3 bedrooms and 2 bathrooms. KRiB 2 can accommodate up to 30 guests with 4 bedrooms and 3 bathrooms. The maximum capacity applies to all guests, including visitors.',
      },
    ],
  },
  {
