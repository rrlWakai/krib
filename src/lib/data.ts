...
export const villas: VillaDetail[] = [
  {
    ...
    capacity: 'Up to 20 guests (60 for parties)',
    bedrooms: 3,
    bathrooms: 6,
    maxGuests: 20,
    highlights: [
    ...
    features: [
      ...
      { icon: 'shower', label: '5 Toilets & Baths + 1 Powder Room' },
    ...
    rates: [
      ...
      { label: 'Capacity', amount: 'Up to 20 Guests', description: 'Additional guests welcome' },
    ],
    policies: [
      { icon: 'login', label: 'Check-in', value: 'Fixed at 2:00 PM' },
      { icon: 'logout', label: 'Check-out', value: '11:00 AM (21-hour stay)' },
      { icon: 'people', label: 'Standard Capacity', value: 'Up to 20 guests' },
      { icon: 'people', label: 'Additional Guests', value: '₱200/person above 20 (requires approval)' },
      { icon: 'smoke_free', label: 'Smoking', value: 'Outdoor areas only' },
      { icon: 'camera', label: 'CCTV', value: 'Active in common areas' },
      { icon: 'party', label: 'Party Policy', value: '₱5,000 party fee (replaces additional guest fee)' },
